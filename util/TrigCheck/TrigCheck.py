...
TwoLSS1tauSR="(passEventCleaning &&dilep_type>0 && nTaus_OR_Pt25==1 && lep_ID_0*lep_ID_1>0 &&(abs(Mll01-91.2e3)>10e3 || abs(lep_ID_0)!=11 || abs(lep_ID_1)!=11) && nJets_OR_T>=2&&nJets_OR_T_MV2c10_70>=1 && lep_Pt_0>20e3 && lep_Pt_1>20e3)"
...
ThreeL1tauSR="(passEventCleaning &&trilep_type>0&&nTaus_OR_Pt25==1&&(total_charge+tau_charge_0)==0&&nJets_OR_T>=2&&nJets_OR_T_MV2c10_70>=1&&(lep_ID_0!=-lep_ID_1||(Mll01>12e3&&abs(Mll01-91.2e3)>10e3))&&(lep_ID_0!=-lep_ID_2||(Mll02>12e3&&abs(Mll02-91.2e3)>10e3)))"
