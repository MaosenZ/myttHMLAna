...
OneL2tauSR="(passEventCleaning && onelep_type>0 && ( abs(lep_ID_0)==13 ||((abs(lep_ID_0)==11)&&lep_isTightLH_0)) && lep_Pt_0>27e3 && lep_isolationFixedCutLoose_0 && nTaus_OR_Pt25==2 && tau_JetBDTSigTight_0 && tau_JetBDTSigTight_1 && tau_tagWeightBin_1<4 && tau_tagWeightBin_0 <4 && tau_passMuonOLR_0==1&&tau_passEleBDT_0==1&&tau_passMuonOLR_1==1&&tau_passEleBDT_1==1)"#&&lep_isTrigMatch_0
TwoLSS1tauSR="(passEventCleaning &&dilep_type>0 && nTaus_OR_Pt25==1 && lep_ID_0*lep_ID_1>0 &&(abs(Mll01-91.2e3)>10e3 || abs(lep_ID_0)!=11 || abs(lep_ID_1)!=11) && lep_Pt_0>20e3 && lep_Pt_1>20e3)"
TwoLOS1tauSR="dilep_type>0&&lep_ID_0*lep_ID_1<0&&(abs(lep_ID_0)!=abs(lep_ID_1) || abs(Mll01-91200)>10000)&&nTaus_OR_Pt25==1"
TwoL2tauSR="(passEventCleaning &&dilep_type>0 && (lep_ID_0*lep_ID_1<0) && ((abs(lep_ID_0)==13 && lep_isolationFixedCutLoose_0 && lep_promptLeptonVeto_TagWeight_0<-0.5) || (abs(lep_ID_0)==11 && lep_isolationFixedCutLoose_0 && lep_isTightLH_0 && lep_chargeIDBDTTight_0>0.7 && lep_ambiguityType_0 == 0 && lep_promptLeptonVeto_TagWeight_0<-0.7)) && ((abs(lep_ID_1)==13 && lep_isolationFixedCutLoose_1 && lep_promptLeptonVeto_TagWeight_1<-0.5) || (abs(lep_ID_1)==11 && lep_isolationFixedCutLoose_1 && lep_isTightLH_1 && lep_chargeIDBDTTight_1>0.7 && lep_ambiguityType_1 == 0 && lep_promptLeptonVeto_TagWeight_1<-0.7)) && nTaus_OR_Pt25==2 && tau_JetBDTSigTight_0 && tau_JetBDTSigTight_1 && tau_charge_0*tau_charge_1<0 && tau_passMuonOLR_0==1 && tau_passEleBDT_0==1 && tau_tagWeightBin_0 <4 && tau_passMuonOLR_1==1 && tau_passEleBDT_1==1 && tau_tagWeightBin_1<4)"
ThreeL1tauSR="(passEventCleaning &&trilep_type>0&&nTaus_OR_Pt25==1&&(total_charge+tau_charge_0)==0&&(lep_ID_0!=-lep_ID_1||(Mll01>12e3&&abs(Mll01-91.2e3)>10e3))&&(lep_ID_0!=-lep_ID_2||(Mll02>12e3&&abs(Mll02-91.2e3)>10e3)))"
...
Count(OneL2tauSR,OnelepTrigs+"||"+New7)
Count(OneL2tauSR,OnelepTrigs+"||"+New8)
...
Count(OneL2tauSR,New7)
Count(OneL2tauSR,New8)
