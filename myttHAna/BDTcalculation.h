...
Float_t tmva1l2tau_leadtaubdtjetsigtrans;
Float_t tmva1l2tau_subtaubdtjetsigtrans;
...
Float_t tmva1l2tau_subtaubtagbin;
...
void initialiseTMVA_tth1l2tau( TString weights, TString myMethodList = "" )
{
  ...
  //reader_tth1l2tau->AddVariable( "Leadtautight+Subtautight"    ,&tmva1l2tau_sumtautight);
