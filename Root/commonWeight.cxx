...
inline double NTUPLE::commonWeight(){
  ...
  /*double wt = mc_channel_number>0?(mc_norm*mcWeightOrg*pileupEventWeight_090*bTagSF_weight_Continuous*lepSFObjTight*
   ...
   double wt=scale_nom*pileupEventWeight_090 *JVT_EventWeight*MV2c10_Continuous_EventWeight*SherpaNJetWeight*( 36074.6*(RunYear < 2016.5) +  43813.7*(RunYear > 2016.5) );
