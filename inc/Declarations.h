...
namespace Declarations{
   ...
   std::string         prefix("/scratchfs/atlas/zhoums/myttHMLAna/doc/"); //define prefix for input sample list
   ...
   std::string         prepath("/scratchfs/atlas/zhoums/GN1Samps/onelep_looseleps/");
